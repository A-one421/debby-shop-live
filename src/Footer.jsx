...
function FooterSection({ title, children, defaultOpen = false }) {
  ...
  return (
    <div>
      ...
      <div
        className={`${open ? "block" : "hidden"} md:block pt-1 pb-4 md:pb-0`}
      >
        <h4
          className="hidden md:block text-[11px] font-bold uppercase tracking-[0.2em] mb-5"
          style={{ color: "#C9A84C" }}
        >
          {title}
        </h4>
  ...
  return (
    <footer className="bg-black text-white pt-16 pb-10">
      <div className="max-w-7xl mx-auto px-5 md:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 md:gap-10 pb-12 border-b border-white/10">
          {/* Brand column */}
          <div className="mb-2 md:mb-0">
            ...
            >
              ...
              <sup
                ...
                style={{ color: "#C9A84C", verticalAlign: "super" }}
              >
                HC
              </sup>
            </button>
          ...
          <FooterSection title="Stay Connected" defaultOpen>
            ...
            <div className="flex items-center border-b border-white/20 pb-2 mb-6">
              <input
                type="email"
                value={email}
                ...
                className="flex-1 bg-transparent text-sm placeholder-gray-600 outline-none text-white min-w-0"
              />
              <button
                onClick={subscribe}
                className="text-[11px] font-bold tracking-widest hover:text-white transition-colors flex-shrink-0 ml-2"
                style={{ color: "#C9A84C" }}
              >
                JOIN →
              </button>
        ...
        {/* Bottom bar */}
        <div className="pt-6 flex flex-col sm:flex-row justify-between items-center text-gray-600 text-xs gap-2">
          <p>
